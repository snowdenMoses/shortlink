...
class ShortLinkRoute implements IRoutes {
    ...
    private initializeRoutes() {
        this.router.get(`${this.path}/:short_url`, this.shortLinkController.redirectShortUrlToLongUrl);
        ...
        this.router.post(`${this.path}/statistics/:short_url`, this.shortLinkController.getShortUrlStatistics);
    }
}
